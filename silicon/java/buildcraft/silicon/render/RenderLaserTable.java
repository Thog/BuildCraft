...
public class RenderLaserTable {// implements ISimpleBlockRenderingHandler {
    ...
    // }
    //
    // private void renderCube(RenderBlocks renderer, boolean isInventory, int xPos, int yPos, int zPos, float xB, float
    // yB, float zB, int w, int h,
    ...
    // }
    //
    // private void renderAdvancedCraftingTable(RenderBlocks renderer, boolean isInv, BlockPos pos, BlockBuildCraft
    // block) {
    // if (!isInv && block.getCurrentRenderPass() != 0) {
    // workaround17(pos);
    // return;
