...
public class TransportProxy {
    ...
    public void registerTileEntities() {
        ...
        // compatibility
        GameRegistry.registerTileEntityWithAlternatives(CompatHooks.INSTANCE.getTile(TileGenericPipe.class), "buildcraft.transport.TileGenericPipe",
        ...
        GameRegistry.registerTileEntityWithAlternatives(CompatHooks.INSTANCE.getTile(TileFilteredBuffer.class),
                "buildcraft.transport.TileFilteredBuffer", "net.minecraft.src.buildcraft.transport.TileFilteredBuffer");
    }
