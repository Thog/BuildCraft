...
public class ContainerEmzuliPipe extends BuildCraftContainer {
    ...
    public void updateProgressBar(int id, int data) {
        paintWidgets[id].colors.setCurrent(data == 0 ? null : EnumDyeColor.fromId(data - 1));
    }
    ...
    private class PaintWidget extends ButtonWidget {
        ...
        private RevolvingList<EnumDyeColor> colors = new RevolvingList<EnumDyeColor>();

        private ToolTip toolTip = new ToolTip(500) {
            @Override
            public void refresh() {
                toolTip.clear();
                EnumDyeColor color = colors.getCurrent();
                if (color != null) {
