...
public class PipePowerIron extends PipePowerBase implements ICustomPipeConnection {
    ...
    protected int solidIconIndex = PipeIconProvider.TYPE.PipePowerIronSolid.ordinal();
    private PipeLogicIron logic = new PipeLogicIron(this) {
        ...
        protected boolean isValidConnectingTile(TileEntity tile, EnumFacing side) {
            ...
            return tile instanceof IMjHandler;
        }
    };
    ...
    // ChatComponentText(String.format(StringUtils.localize("chat.pipe.power.iron.mode.numberless"),
    ...
    public float getExtension(World world, BlockPos pos, EnumFacing face, IBlockState state) {
        ...
        if (tile instanceof TileGenericPipe) {
            ...
            if (genericPipe.pipe instanceof PipePowerIron) {
                PipePowerIron otherPipe = (PipePowerIron) genericPipe.pipe;
