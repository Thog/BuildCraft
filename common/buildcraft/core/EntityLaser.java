...
public abstract class EntityLaser extends Entity {
	...
	public static final ResourceLocation[] LASER_TEXTURES = new ResourceLocation[]{
		new ResourceLocation(DefaultProps.TEXTURE_PATH_ENTITIES + "/laser_1.png"),
		new ResourceLocation(DefaultProps.TEXTURE_PATH_ENTITIES + "/laser_2.png"),
		new ResourceLocation(DefaultProps.TEXTURE_PATH_ENTITIES + "/laser_3.png"),
		new ResourceLocation(DefaultProps.TEXTURE_PATH_ENTITIES + "/laser_4.png"),
		new ResourceLocation(DefaultProps.TEXTURE_PATH_ENTITIES + "/stripes.png"),
		new ResourceLocation(DefaultProps.TEXTURE_PATH_ENTITIES + "/blue_stripes.png")};
